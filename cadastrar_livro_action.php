...
$url_capa = 'img/default-cover.jpg'; // Caminho padrão caso ocorra falha
...
// Fluxo de Processamento de Arquivo de Imagem
if (isset($_FILES['capa_arquivo']) && $_FILES['capa_arquivo']['error'] === UPLOAD_ERR_OK) {
    ...
    $extensionsPermitidas = ['jpg', 'jpeg', 'png']; // Permite apenas arquivos de imagem comuns
    ...
    if (in_array($fileExtension, $extensionsPermitidas)) {
        ...
        // Direciona para a pasta local 'img/' exibida na raiz do projeto
        $uploadFileDir = 'img/';
